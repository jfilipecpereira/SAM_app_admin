...
export default class Login extends Component {
    ...
    onSignin = async () => {
                ...
                try{
                    ...
                    AsyncStorage.setItem('admtkn', JSON.stringify(res.data))
                    ...
                    if(id_aluno === null){
                        ...
                        Alert.alert('Versão da aplicação para a Administração!')
    ...
    render() {
        ...
        return(
            ...
            <View style={styles.background}>
                ...
                <Text style={styles.subtitle}>Autenticação - Administração</Text>
